...
METALLB_HELM_CHART_VERSION="${METALLB_HELM_CHART_VERSION}"
METALLB_IP_RANGE_START="${METALLB_IP_RANGE_START}"
METALLB_IP_RANGE_END="${METALLB_IP_RANGE_END}"
INSTALL_GATEWAY_API_CONTROLLER="${INSTALL_GATEWAY_API_CONTROLLER}"
GATEWAY_API_CONTROLLER_REPLICAS="${GATEWAY_API_CONTROLLER_REPLICAS}"
GATEWAY_API_EXTERNAL_LB_PORT="${GATEWAY_API_EXTERNAL_LB_PORT}"
ENVOY_GATEWAY_HELM_CHART_VERSION="${ENVOY_GATEWAY_HELM_CHART_VERSION}"
NGINX_GATEWAY_HELM_CHART_VERSION="${NGINX_GATEWAY_HELM_CHART_VERSION}"
...
PREPARE_LONGHORN_REQUIREMENTS="${PREPARE_LONGHORN_REQUIREMENTS}"
...
INSTALL_KUBE_PROMETHEUS_STACK="${INSTALL_KUBE_PROMETHEUS_STACK}"
KUBE_PROMETHEUS_STACK_HELM_CHART_VERSION="${KUBE_PROMETHEUS_STACK_HELM_CHART_VERSION}"
ENABLE_NODE_EXPORTER="${ENABLE_NODE_EXPORTER}"
ENABLE_KUBE_STATE_METRICS="${ENABLE_KUBE_STATE_METRICS}"
...
INSTALL_ARGOCD_SERVER="${INSTALL_ARGOCD_SERVER}"
ARGOCD_SERVER_VERSION="${ARGOCD_SERVER_VERSION}"
